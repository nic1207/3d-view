...
function init() {
       ...
       makeStarParticles();
        ...
        var r = new THREE.Vector3(1, 0, 1);
        drawCircleLine(r,300,0x3399ff);//0xFFCC66

        r = new THREE.Vector3(1, 0, 1);
        drawCircleLine(r,200,0xffcc66);//0x3399ff
       ...
       * @return {[type]} [description]
       */
      function drawCircleLine(r,amplitude,color,noParticle) {
        var numPoints = 100;
      ...
      function render() {
        ...
        var t = -r/3;
        mesh_bigdata.position.x = Math.cos( t ) * 300;//bigdata
        //mesh_bigdata.position.y = Math.cos( t ) * 300;//bigdata
        mesh_bigdata.position.z = Math.sin( t ) * 300;//bigdata

        //mesh_bigdata.rotation.z = 180;//bigdata
        mesh_4g.position.x = Math.cos( t ) * -300;//bigdata
        //mesh_4g.position.y = Math.cos( t ) * -300;//bigdata
        mesh_4g.position.z = Math.sin( t ) * -300;//bigdata
        ...
        //console.log(t);
        //console.log(t );
        mesh_phone.position.x = Math.cos( t ) * 200 ;
        //mesh_phone.position.y = Math.cos( t ) * 300 * -0.2;
        mesh_phone.position.z = Math.sin( t ) * 200;
        mesh_phone.lookAt(camera.position);

        t+=150;
        mesh_pad.position.x = Math.cos( t ) * 200 ;
        //mesh_pad.position.y = Math.cos( t ) * 300 * -0.2;
        mesh_pad.position.z = Math.sin( t ) * 200;
        mesh_pad.lookAt(camera.position);

        t+=150;
        mesh_nb.position.x = Math.cos( t ) * 200 ;
        //mesh_nb.position.y = Math.cos( t ) * 200  * -0.2;
        mesh_nb.position.z = Math.sin( t ) * 200;
        mesh_nb.lookAt(camera.position);

        t+=150;
        mesh_aio.position.x = Math.cos( t ) * 200 ;
        //mesh_aio.position.y = Math.cos( t ) * 200  * -0.2;
        mesh_aio.position.z = Math.sin( t ) * 200;
        mesh_aio.lookAt(camera.position);

        t+=150;
        mesh_ptv.position.x = Math.cos( t ) * 200 ;
        //mesh_ptv.position.y = Math.cos( t ) * 200  * -0.2;
        mesh_ptv.position.z = Math.sin( t ) * 200;
        mesh_ptv.lookAt(camera.position);

        t+=150;
        mesh_tv.position.x = Math.cos( t ) * 200 ;
        //mesh_tv.position.y = Math.cos( t ) * 200 * -0.2 ;
        mesh_tv.position.z = Math.sin( t ) * 200;
        mesh_tv.lookAt(camera.position);

        t+=150;
        mesh_board.position.x = Math.cos( t ) * 200 ;
        //mesh_board.position.y = Math.cos( t ) * 200 * -0.2;
        mesh_board.position.z = Math.sin( t ) * 200;
        mesh_board.lookAt(camera.position);

        t+=150;
        mesh_led.position.x = Math.cos( t ) * 200 ;
        //mesh_led.position.y = Math.cos( t ) * 200  * -0.2;
        mesh_led.position.z = Math.sin( t ) * 200;
        mesh_led.lookAt(camera.position);
